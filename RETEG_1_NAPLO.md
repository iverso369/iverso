...
| 7 | react-i18next váz (HU/DE/EN, namespace-es JSON, nyelv detekció + váltó) | 🟡 prompt kész |
| 8 | Vercel config (SPA fallback) | 🟡 prompt kész |
...
### Prompt 04 — i18n + Vercel 🟡 végrehajtásra vár
- react-i18next + i18next + i18next-browser-languagedetector telepítése
