...
| # | Feladat | Állapot |
|---|---------|---------|
| 1 | Vite + React + TypeScript projekt | 🟡 prompt kész |
| 2 | Mappa struktúra (CLAUDE.md szerint) | 🟡 prompt kész |
...
|---|------|-----------|---------|
| 01 | RETEG_1_PROMPT_01.md | 1-2 (projekt + mappa struktúra) | kész, végrehajtásra vár |
