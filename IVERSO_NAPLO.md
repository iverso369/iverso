...
- Még hátra: DashboardPreview újratervezés, WebsitePreview újratervezés, Építős szekció, Folyamat finomhangolás
...
**Amit most csinálunk:** Réteg 4 javítások folytatása — következő: DashboardPreview újratervezés (gazdagabb tartalom: sidebar, táblázat, tab váltás).
