...
Animáció:       Gépen: Three.js (hero 3D parázs) + CSS / Mobilon: CSS + Canvas 2D
...
- Three.js + Canvas 2D komponensek egyszerűen kezelhetők React-ben
...
│   │   ├── hero/            # Parázs hero (Three.js gépen, Canvas 2D mobilon)
...
- Mobilon: CSS + Canvas 2D (könnyebb, ugyanaz a hangulat)
...
- Morph: Gépen fancy expand effekt / Mobilon smooth slide-up teljes képernyőre
